...
public class Test123 {
  ...
  public void test123() throws Exception {
    ...
    System.out.println(driver.findElement(By.xpath("//html/body/table/tbody/tr[2]/td/table/tbody/tr/td/span")).getText());
    assertTrue(driver.findElement(By.xpath("//html/body/table/tbody/tr[2]/td/table/tbody/tr/td/span")).getText().matches("^申请表[\\s\\S]*$"));
  }
